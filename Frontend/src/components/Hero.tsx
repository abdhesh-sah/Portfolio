...
import { ArrowRight, Mail, ChevronDown, Sparkles, Code2, ExternalLink, Globe } from "lucide-react";
import { Github, Linkedin, Twitter, Instagram, Youtube } from "#src/components/icons/brand-icons";
